package by.itacademy.flats.repository.entity;

import jakarta.persistence.*;
import by.itacademy.flats.core.enums.*;
import by.itacademy.flats.core.converter.*;
...
public class FlatEntity {
    ...
    public String toString() {
        return "FlatEntity{ " +
                ...
                "floor= " + floor + "\n" +
                "bedrooms= " + bedrooms + "\n" +
                "photo_urls= " + photo_urls.stream().map(p -> p + "\n").toList() + "\n" +
