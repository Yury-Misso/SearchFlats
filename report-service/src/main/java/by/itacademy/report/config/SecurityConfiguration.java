...
//                        .requestMatchers(POST, "/api/v1/report/{type}").hasRole("ADMIN")
//                        .requestMatchers(GET, "/api/v1/report").hasRole("ADMIN")
//                        .requestMatchers(GET, "/api/v1/report/{uuid}/export").hasRole("ADMIN")
//                        .requestMatchers(HEAD, "/api/v1/report/{uuid}/export").hasRole("ADMIN")
